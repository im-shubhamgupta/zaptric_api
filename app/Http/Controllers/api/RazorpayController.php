...
class RazorpayController extends Controller
{
    ...
    // API to verify payment after successful payment from Razorpay
   /* public function verifyPayment(Request $request)
    ...
    {
        $count = $request->input('count', 10); // default 10 orders
        $skip = $request->input('skip', 0); // default no skipping
